...
`EXPO_PUBLIC_OBSERVE_IN_DEV=1` and Improve SpeakWell enabled. Exercise a practice retry,
...
normally when Improve SpeakWell is enabled. Exclude `practice_engine: mock` from
