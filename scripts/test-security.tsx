...
const receipt = (store: string, sandbox: boolean) => ({ entitlements: { 'SpeakWell Pro': { expires_date: new Date(Date.now() + 86400000).toISOString(), product_identifier: 'annual' } }, subscriptions: { annual: { store, is_sandbox: sandbox } } });
