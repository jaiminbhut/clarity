...
/** Must equal `PRO_ENTITLEMENT_ID` in lib/entitlements.ts and the RevenueCat
 * entitlement id exactly; a mismatch reads every subscriber as unsubscribed. */
export const PRO_ENTITLEMENT = 'SpeakWell Pro';
